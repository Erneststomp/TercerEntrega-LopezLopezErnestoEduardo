...
io.on('connection', socket=>{
    ...
    socket.on('cartsredirect',async()=>{
        let destination = config.url.mainurl+'/carts';
        io.emit('cartredirect', destination);
    })

    socket.on('productsredirect',async()=>{
        let destination = config.url.mainurl+'/products';
        io.emit('productredirect', destination);
    })
